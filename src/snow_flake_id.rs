...
pub mod tests {
	...
	pub(crate) const SAMPLE_SCR: u64 = 175_928_847_299_678_215;
	const EXPECTED_MACHINE_ID: u16 = 169;
	pub(crate) const EXPECTED_INCLEMENT: u16 = 7;
	pub(crate) const EXPECTED_RAW_TIMESTAMP: u64 = 41_944_705_796;
	pub(crate) static EXPECTED_TIMESTAMP: LazyLock<DateTime<Utc>> = LazyLock::new(|| {
	...
	pub(crate) static THE_EPOCH: LazyLock<DateTime<Utc>> =
	...
	fn timestamp_test() {
		let actual = fixture();
		assert_eq!(actual.timestamp(*THE_EPOCH, &Utc), *EXPECTED_TIMESTAMP);
	}
